  ...
  <div class="hero-full-container background-image-container white-text-container">
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <h1>re - Creators</h1>
          <p>SELAMAT DATANG DI WEBSITE RE - CREATORS.</p>
          <br>
      ...
      <div class="row">
        <div class="col-xs-12 col-md-8 col-md-offset-2">
          <div class="text-center">
            <h2>About Us</h2>
            <p>re - Creators merupakan sebuah startup yang berada dibidang multimedia, baik itu desain maupun video editor. 
            <br>
            Disini kami menawarkan jasa yang kalian perlukan dengan service yang memuaskan.</p>
          </div>
       </div>
      </div>
    </div>
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        ...
                        <div class="carousel-caption card-shadow reveal">
                          ...
                          <p>
                            Menawarkan service yang friendly.
                          </p>
