                            ...
                            <div class="basic-form">
                                 <form method="POST" action="{{ URL('pelanggan/pemesanan/') }}">
                                    ...
                                    <div class="form-group">
                                        <label for="id_restoran">Jasa</label>
                                    ...
                                    <ul class="nav nav-tabs customtab" role="tablist">
                                        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#makanan" role="tab"><span class="hidden-sm-up"><i class="ti-fire"></i></span> <span class="hidden-xs-down">Desain Grafis</span></a> </li>
                                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#minuman" role="tab"><span class="hidden-sm-up"><i class="ti-fire"></i></span> <span class="hidden-xs-down">Video Editor</span></a> </li>
                                    </ul>
                                    <!-- Tab panes -->
