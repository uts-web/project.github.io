                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="{{{(Request::is('pelanggan/reservasi') ? 'active' : '')}}}"> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-envelope"></i><span class="hide-menu">Reservasi</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{URL('pelanggan/reservasi')}}">Semua Pesanan</a></li>
                        ...
                        <li class="{{{(Request::is('pelanggan/hidangan') ? 'active' : '')}}}"> <a href="{{URL('pelanggan/hidangan')}}" aria-expanded="false"><i class="fa fa-fire"></i>Jasa Tersedia </a></li>
