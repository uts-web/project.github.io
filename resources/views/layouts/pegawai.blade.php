                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="{{{(Request::is('pegawai') ? 'active' : '')}}}"> <a href="{{URL('pegawai')}}" aria-expanded="false"><i class="fa fa-tachometer"></i>Dashboard </a></li>  
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{URL('pegawai/pegawai')}}">Semua Creators</a></li>
                                <li><a href="{{URL('pegawai/pegawai/create')}}">Buat Akun Creators</a></li>
                            </ul>
                        </li>
                        <li class="{{{(Request::is('pegawai/hidangan') ? 'active' : '')}}}"> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-fire"></i><span class="hide-menu">Produk</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{URL('pegawai/hidangan')}}">Semua Produk</a></li>
                                <li><a href="{{URL('pegawai/hidangan/create')}}">Tambah Produk</a></li>
                            </ul>
                        </li>
                        <li class="{{{(Request::is('pegawai/restoran') ? 'active' : '')}}}"> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-home"></i><span class="hide-menu">Jasa</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{URL('pegawai/restoran')}}">Semua Jasa</a></li>
                                <li><a href="{{URL('pegawai/restoran/create')}}">Tambah Jasa</a></li>
                            </ul>
                        </li>
