                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header text-center">
                            <br><br>
                            <h3>List dari semua Kategori</h3>
                        </div>
                        <a href="kategoris/add" class="btn btn-primary">Tambahkan Data</a>
                        </br>
                        <div class="card body">
            ...
            <blockquote>
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header text-center">
                            <br><br>
                            <h3>List dari semua Komentar</h3>
                        </div>
