...
<link href=" {{ asset('ela/css/lib/sweetalert/sweetalert.css') }}" rel="stylesheet">
        <a href="{{URL('pegawai/hidangan/create')}}" class="btn btn-success">Tambah Produk</a>

        <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs customtab" role="tablist">
                            <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#makanan" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Desain Grafis</span></a> </li>
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#minuman" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Video Editor</span></a> </li>
                        </ul>
                        <!-- Tab panes -->
                ...
                <script type="text/javascript">
                    $('form').submit(function(e){
                        ...
                        swal({
                                ...
                                text: "Produk yang dihapus tidak bisa dikembalikan lhoo.",
                                type: "warning",
