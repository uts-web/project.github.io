                            ...
                            <div class="basic-form">
                                <form method="POST" action="{{ URL('pegawai/reservasi') }}">
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-sm-2 col-form-label">Jasa</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-sm-2 col-form-label">Nama Creators</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="no_meja_reservasi" class="col-sm-2 col-form-label">Nomor Antrean</label>
                                        <div class="col-sm-10">
